...
class MLListening:
    def __init__(self, basic_pitch_path, midi_bus, channels=1, sample_rate=22050, 
        ...
        self.repeat_same_chord = repeat_same_chord  # Flag to control chord repetition
        self.midi_offset = midi_offset  # MIDI note offset for middle C (C4)
        self.chord_seconds = chord_seconds # Duration to hold the chord note
    ...
    def send_midi_chord(self, midi_notes):
